        ...
        >
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#11418D] px-7 py-3.5 text-sm sm:text-base font-bold text-white transition-all hover:bg-[#11418D] hover:shadow-lg hover:shadow-blue-900/30"
            >
